        ...
        <div className="container-fluid">
            <div className="card-group">
                ...
                <div className="card text-white bg-secondary" style={{width: 22 + 'rem', height: 25 + 'rem', margin: 2.5 + 'px'}}>
                    ...
                    <img src="step2.gif" height="250px" width="150px" className="center"/>
                </div>  
                <div className="card text-white bg-secondary" style={{width: 22 + 'rem', height: 25 + 'rem', margin: 2.5 + 'px'}}>
            ...
            <div className="card-group">
                ...
                <div className="card text-white bg-secondary" style={{width: 22 + 'rem', height: 25 + 'rem', margin: 2.5 + 'px'}}>
                    ...
                    <p>Don't forget to checkout with MetaMask! Make sure you submit the transaction to have your vote recorded</p>
