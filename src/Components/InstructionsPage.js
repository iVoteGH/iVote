        ...
        <div className="container-fluid">
          <div className="card-group">
            ...
            >
              ...
              <div className="card-text">
                <p>
                  Click on each candidate to learn more about their voting
                  record and recent press
                </p>
              </div>
              <img
                src="step3.gif"
          ...
          <div className="card-group">
            ...
            >
              ...
              <div className="card-text">
                <p>
                  When you are ready to vote, click the "Go To Ballot" button
                </p>
              </div>
            ...
            >
              ...
              <div className="card-text">
                <p>
                  On the ballot page, first select the candidate you wish to
                  vote for, and then click the "Vote For" button
                </p>
              </div>
            ...
            >
              ...
              <p>
                ...
                click SUBMIT on the transaction to have your vote recorded
              </p>
              <img
                src="step6.gif"
                height="250px"
          ...
          <div className="card-group">
            ...
            >
              <p>
                <strong>GO MEET THE CANDIDATES</strong>
              </p>
              <div className="card-text">
                <p>Click below to</p>
                <p> Get Started and Meet the Candidates!</p>
              </div>
              <Link to="/info">
                <button
                  type="button"
